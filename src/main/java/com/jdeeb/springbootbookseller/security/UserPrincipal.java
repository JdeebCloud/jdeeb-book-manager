...
public class UserPrincipal implements UserDetails
{
    ...
    transient private String password; // don't show up in serialized places
    transient private User user; // user for only login operations, don't use in JWT
    private Set<GrantedAuthority> authorities;

    public static UserPrincipal createSuperUser(){
        Set<GrantedAuthority> authorities1 = Set.of(SecurityUtil.convertToAuthority(Role.SYSTEM_MANAGER.name()));
